<?php	
	...
	if ($_POST['acao']=='atualizar pagina'){
		...
		$sql = "insert into paginas (nome,conteudo,data_inicio) values ('conteudo_lateral','".$conteudo."','".$data_hora."');";
		echo $sql;
...
?>
	...
	<title>editor de conteudo lateral</title>
	...
	<form action="?pagina=home" method="post">
		<label for="editor1">Editor da pagina donwload</label><br>
