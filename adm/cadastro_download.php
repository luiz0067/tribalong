<?php	
	...
	$row=null;
	$result=null;
	$sql	= "SELECT codigo,nome,conteudo,data_inicio,data_fim FROM paginas where (nome='donwload') and (data_fim is null) order by data_inicio desc";
	...
	if ($_POST['acao']=='atualizar pagina'){
		...
		$sql = "insert into paginas (nome,conteudo,data_inicio) values ('download','".$conteudo."','".$data_hora."');";
...
?>
	...
	<form action="?pagina=home" method="post">
		<label for="editor1">Editor da pagina download</label><br>
